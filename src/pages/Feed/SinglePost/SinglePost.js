      ...
      `
        ...
        fetch('http://localhost:8080/graphql', {
            ...
            .then(resData => {
                ...
                const imageUrl = 'http://localhost:8080/' + resData.data.getPost.imageUrl;
                const decodedImageUrl = decodeURIComponent(imageUrl).replace("\\", "/");
                console.log("Saved image Url is ", decodedImageUrl)
                this.setState({
