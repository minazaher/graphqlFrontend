...
class Feed extends Component {
    ...
    componentDidMount() {
        const graphqlQuery = {query: `{ getUser { status } } `}
        ...
        fetch('http://localhost:8080/graphql', {
            ...
            .then(resData => {
                ...
                this.setState({
                    ...
                    totalItems: resData.data.getAllPosts.totalItems,
                    postsLoading: false
                });
            })
            .catch(this.catchError);
...
`
    ...
    deletePostHandler = postId => {
        ...
        const graphqlQuery = {query: `mutation { deletePost(id: "${postId}") }`}
